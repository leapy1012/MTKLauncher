    ...
    public void execute(@NonNull final LauncherAppState app, @NonNull final BgDataModel dataModel,
        ...
        synchronized (dataModel) {
            ...
            for (Pair<ItemInfo, Object> entry : mItemList) {
                ...
                if (item != null) {
                    ItemInfo finalItem = item;
                    boolean exists = filteredItems.stream()
                            .anyMatch(existingItem -> Objects.equals(existingItem.getTargetComponent(), finalItem.getTargetComponent()));
                    if (!exists) {
            ...
            for (ItemInfo item : filteredItems) {
                ...
                //hxy-bug clone app bug
                    ...
                    boolean hasActivity = activities != null && !activities.isEmpty();
                    if (hasActivity) {
                        apps.add(new AppInfo(app.getContext(), activities.get(0), item.user), activities.get(0), app.getContext());
                    }
                }
